...
@media print {
    ...
    table th, table td {
        border: 1px solid #ccc; /* Penyesuaian border untuk tampilan cetak */
    }

    /* Pastikan font lebih besar dan jelas */
    table th, table td, #legalcopy, #top h2 {
        font-size: 14px;
    }

    #top h2 {
        font-size: 24px; /* Ukuran font lebih besar untuk nama toko */
    }
}
